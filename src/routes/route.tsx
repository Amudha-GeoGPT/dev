...
import StaticCard from '../components/dashboard/dashboard card/card';

// import ToggleButtonComponent from '../components/dashboard/dashboard card/toggleButton';
...
const Router = [
  {
    ...
    children: [
      ...
      // { 
      //   path: '/Staticmacoutletplanning', 
      //   element: <ToggleButton onToggle={onToggleHandler} /> 
      // },
    ],
  },
];
